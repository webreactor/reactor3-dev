...
if(!$this->server)return "<br><b>Mailer Error:</b> Can't open $server!<br>";
$t=fgets($this->server);
$t=explode(' ',$t);$t=$t[1];
...
{
$boundary=$this->boundary;
if(!is_file($fname))return "<br><b>Mailer Error:</b> Can't open file $fname!<br>";
$fd = fopen($fname, 'r');
...
$boundary=$this->boundary;
$from=$this->from;
if($this->text=='')return "<br><b>Mailer Error:</b> Don't create letter<br>";
