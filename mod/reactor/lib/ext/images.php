...
if($t[2]==1)$us=@imagecreatefromgif($file_src);
if($t[2]==2)$us=@imagecreatefromjpeg($file_src);
if($t[2]==3)$us=@imagecreatefrompng($file_src);
if($t[2]==6)$us=@r_imagecreatefrombmp($file_src);
