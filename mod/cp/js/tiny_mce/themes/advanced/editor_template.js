...
var TinyMCE_AdvancedTheme = {
	...
	getControlHTML : function(button_name) {
		...
		switch (button_name) {
			case "formatselect":
				...
				var formats = tinyMCE.getParam("theme_advanced_blockformats", "p,address,pre,h1,h2,h3,h4,h5,h6,blockquote,code", true).split(',');
				var lookup = [
	...
	getEditorTemplate : function(settings, editorId) {
		...
		switch(layoutManager) {
			case "SimpleLayout" : //the default TinyMCE Layout (for backwards compatibility)...
				...
				var defVals = {
					theme_advanced_buttons1 : "bold,italic,underline,separator,justifyleft,justifycenter,justifyright,justifyfull,separator,bullist,numlist,sub,sup,separator,link,unlink,image",//,styleselect
					theme_advanced_buttons2 : "separator,removeformat,cleanup,codeseparator,separator,charmap,code,formatselect"
				};
	...
	handleNodeChange : function(editor_id, node, undo_index, undo_levels, visual_aid, any_selection, setup_content) {
		...
		if (selectElm) {
			var elm = tinyMCE.getParentElement(node, "p,address,pre,h1,h2,h3,h4,h5,h6,blockquote,code");
