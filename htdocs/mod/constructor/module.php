...
require $_reactor['module']['dir'] . 'lib/create_rmp.php';
require $_reactor['module']['dir'] . 'lib/install_rmp.php';
require $_reactor['module']['dir'] . 'lib/uninstall_rmp.php';
require $_reactor['module']['dir'] . 'lib/update_module.php';
